...
//                    ,array('style'=>'float: right;',)
	...
	<div class="nav">
		...
		Last updated on <?php echo date('F j, Y',$data->update_time); ?><br/>
        <?php $this->widget('ext.sharebox.EShareBox', array('url' => $this->createAbsoluteUrl($data->url), 'title'=> $data->title,'htmlOptions'=>array('style'=>'padding-left: 1em'))); ?>
	</div>
</div>
<?php
if($data->imgs) {
